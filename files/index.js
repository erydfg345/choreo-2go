...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'choreo5.ebf54tlab.gq';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiNWM2MjkyYzBkOWMxM2VmM2NlNmZhMjgxZTFhYTM5ZDEiLCJ0IjoiZGY1MTViMDYtNTczYy00NmU0LWE1OGQtOTA2ZTYyMTk2YTdmIiwicyI6Ik9EVTJaVE0zT0RrdE1HTmpOaTAwT0RVMUxUazFaalV0TmpJMlpUWmxOMlpsTURVeCJ9';
